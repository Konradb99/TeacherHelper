...
class fragment_classes : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val factory = ClassesListViewModelFactory((requireNotNull(this.activity).application))
        viewModelList = ViewModelProvider(requireActivity(), factory).get(ClassesListViewModel::class.java)
        ...
        view.findViewById<Button>(R.id.buttonAddGroup).apply{
            setOnClickListener{
                val lecture= Lecture(0, "AMSA")
                viewModelList.AddClass(lecture)
            }
        }
    }
